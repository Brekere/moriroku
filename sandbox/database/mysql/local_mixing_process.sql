...
CREATE TABLE MixContainer(
    ...
    viscosity float,
    weight float, 
    humidity float, -- porcentaje de humedad ...  1 - 100
    temperature float,
...
INSERT INTO MachineInformation (id_in, name, description, start_up) VALUES ('XFc340PG', 'Maquina No. 1 de Prcoeso de Mezclado', 'Máquina para registrar y trazar el proceso de mezclado de pintura para los diferentes modelos', '2022-07-03 12:00:00');
